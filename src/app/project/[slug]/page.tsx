    ...
    <div className="bg-background">
      <div className="container mx-auto px-4 py-12">
        <div className="mb-8">
          <Link
            href="/"
            className="inline-flex items-center text-lg font-medium text-muted-foreground hover:text-primary transition-colors font-headline"
          >
        ...
        <header className="mb-12 text-center">
          <Badge variant="secondary" className="mb-4 font-headline text-lg">
            {project.category}
          </Badge>
          <h1 className="text-4xl md:text-6xl font-bold font-headline text-foreground">
            {project.title}
          </h1>
          <p className="mt-4 text-lg text-muted-foreground max-w-3xl mx-auto font-headline">
